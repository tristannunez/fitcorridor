---
title: "fitcorridor Vignette (Version 0.1)"
author: "Tristan Nuñez"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{fitcorridor Vignette (Version 0.1)}
...
### Setting up
First, set your working directory to the vignette folder:
```{r, message=F}
...
```
This takes several minutes on a laptop (Intel(R) Core(TM) i7-4910MQ CPU @ 2.90GHz) with 4 cores. Disregard the "In .local(x, ...) : all fact(s) were 1, nothing to aggregate" warning. Let's explore each of the arguments for the FitSingleModel function:
